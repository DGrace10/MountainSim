...
bool UserInterfaceClass::Initialize(D3DClass* Direct3D, int screenHeight, int screenWidth)
{
	...
	result = m_Font1->Initialize(Direct3D->GetDevice(), Direct3D->GetDeviceContext(), "../MountainSim/data/font/font01.txt", 
								 "../MountainSim/data/font/font01.tga", 32.0f, 3);
	if (!result)
	{
		return false;
	}
